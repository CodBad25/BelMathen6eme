/**
 * Théâtre d'Épidaure v9 - Construction à la règle et au compas
 *
 * Approche pédagogique :
 * 1. Tracer TOUS les rayons avec le report d'angle (méthode connue de l'élève)
 * 2. Tous les rayons vont de l'orchestre jusqu'en haut, avec DIAZOMA VIDE
 * 3. Gommer la partie inférieure d'un rayon sur deux
 *
 * v9 : Diazoma vide - les rayons s'interrompent dans la bande du diazoma
 * Résultat : zone inférieure avec rayons espacés, zone supérieure avec tous les rayons
 */

// Configuration - Proportions fidèles au vrai théâtre (v9)
...
async function buildEpidaureAnimated() {
    ...
    // ========================================
    // ÉTAPE 4 : Premier rayon vertical (90°) - en 2 segments (diazoma vide)
    // ========================================
