...
// Configuration - Proportions fidèles au vrai théâtre (v5)
// Ratio zone inf / zone sup = 2:1
const CONFIG = {
    centerX: 375,
    centerY: 520,
    ...
    // Zone inférieure (koilon inférieur) - ratio 2:1 avec zone sup
    zone1Start: 62,
    zone1Rows: 24,              // 24 rangées
    zone1Step: 4.5,             // Espacement serré

    // Diazoma (couloir large et visible)
    diazomaWidth: 15,

    // Zone supérieure (koilon supérieur) - ratio 2:1 avec zone inf
    zone2Rows: 12,              // 12 rangées (moitié de zone inf)
    zone2Step: 4.5,             // Même espacement
