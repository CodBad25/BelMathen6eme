...
async function buildSpiralAnimated() {
    ...
    updateStepInfo('Décoration', 'Ajoutons une touche de couleur !');
    await canvas.wait(600);
    ...
    // Centre du SVG (là où la spirale est visible après le zoom)
    const centerX = svgWidth / 2;
    const centerY = svgHeight / 2;

    // Zone de dispersion des confettis (centrée sur la spirale)
    const confettiSpread = 350;
    ...
    for (let i = 0; i < 45; i++) {
        ...
        // Centrer les confettis autour du centre de la spirale
