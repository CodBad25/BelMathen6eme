...
// Configuration - Proportions fidèles au vrai théâtre (v4)
const CONFIG = {
    centerX: 375,
    centerY: 520,
    ...
    // Orchestre (cercle complet) - ~20-25% du rayon total
    orchestraRadius: 55,

    // Zone inférieure (koilon inférieur) - ~60-65% du rayon total
    zone1Start: 62,
    zone1Rows: 32,              // Beaucoup plus de rangées
    zone1Step: 4.5,             // Espacement très serré

    // Diazoma (couloir large et visible) - situé à ~75% du rayon
    diazomaWidth: 15,

    // Zone supérieure (koilon supérieur) - ~10% du rayon total
    zone2Rows: 6,
    zone2Step: 4.5,             // Espacement serré aussi
