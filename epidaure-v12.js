...
async function buildEpidaureAnimated() {
    ...
    // Centre du SVG (là où le théâtre est visible après le zoom)
    const centerX = svgWidth / 2;
    const confettiSpread = 400;  // Zone de dispersion centrée
    ...
    for (let i = 0; i < 35; i++) {
        ...
        // Centrer les confettis autour du centre du théâtre
