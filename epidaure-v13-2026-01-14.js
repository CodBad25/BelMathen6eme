/**
 * Theatre d'Epidaure v13 - 2026-01-14
 *
 * Basé sur v12 avec mode Exploration synchronisé avec l'Animation
 * Les étapes sont identiques dans les deux modes
 */

// Configuration - Identique à v12
const CONFIG = {
    centerX: 375,
    centerY: 750,
    baseAngle: 9,
...
function initConfig() {
    ...
    constructionRadius = CONFIG.zone1Start;
}
...
// ============================================
// CONSTRUCTION ANIMÉE (identique à v12)
// ============================================
async function buildEpidaureAnimated() {
    ...
    // ÉTAPE 4 : Arc extérieur
    updateStepInfo('Arc exterieur', 'On trace l\'arc de la derniere rangee (long).');
    await canvas.wait(400);
    ...
    // ÉTAPE 7 : Arc de construction pour report d'angle
    ...
    // ÉTAPE 10 : Rayons vers la gauche
    updateStepInfo('Reports a gauche', 'On reporte l\'angle vers la gauche.');
    await canvas.wait(400);
    ...
    // ÉTAPE 11 : Rayons vers la droite
    updateStepInfo('Reports a droite', 'On reporte l\'angle vers la droite.');
    await canvas.wait(400);
    ...
    // ÉTAPE 12 : Gommage rayons zone inf
    ...
    // ÉTAPE 13 : Gommage rayons zone sup
    ...
    // ÉTAPE 14 : Rangées zone inférieure
    ...
    // ÉTAPE 16 : Rangées zone supérieure
...
function buildSteps() {
    ...
    steps.push({
        title: 'Arc exterieur',
        description: 'On trace l\'arc de la derniere rangee (long).',
        render: () => {
    ...
    // ÉTAPE 7 : Arc de report
    steps.push({
        title: 'Arc de report',
        description: 'On trace un arc pour le report d\'angle.',
        render: () => {
            drawArc(O.x, O.y, constructionRadius, minAngle, maxAngle, CONFIG.chordColor, 1.5);
        }
    });

    // ÉTAPE 8 : Angle de base (deuxième rayon + corde)
    steps.push({
        title: 'Angle de base',
    ...
    // ÉTAPES 9-N : Reports d'angle (un rayon par étape)
    ...
    steps.push({
        ...
        render: () => {
            // On redessine les arcs zone sup avec l'étendue réduite
            // (les anciens arcs longs sont "effacés" en ne les redessinant pas)
            ...
            // Arc du diazoma (début) reste long
            drawArc(O.x, O.y, diazomaStart, minAngle, maxAngle, CONFIG.mainArcColor, 3);
        }
    });
